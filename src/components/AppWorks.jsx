const AppWorks = () => {
  return (
    <div className="w-full lg:h-screen md:h-[90vh] h-[100vh] flex flex-col lg:justify-center items-center gap-8 md:my-8 lg:mt-0">
      ...
      <div className="lg:w-[25%] md:w-[40%] w-[80%] md:h-[80%] h-[60%] flex flex-col justify-center items-center text-center gap-2 bg-custom-gradient2 hover:bg-custom-gradient3 rounded-md p-4">
